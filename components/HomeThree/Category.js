          ...
          <div className="row justify-content-center">
            <div className="col-xl-2 col-lg-4 col-md-6 col-sm-6">
              <div className="category-item bg-heath">
                ...
                <div className="category-text">
                  <h4>
                    <Link href="/tours">City Tours</Link>
                  </h4>
                  <span>24+ tour</span>
                </div>
              </div>
            ...
            <div className="col-xl-2 col-lg-4 col-md-6 col-sm-6">
              <div className="category-item bg-heath">
                ...
                <div className="category-text">
                  <h4>
                    <Link href="/tours">Historical</Link>
                  </h4>
                  <span>44+ tour</span>
                </div>
              </div>
            ...
            <div className="col-xl-2 col-lg-4 col-md-6 col-sm-6">
              <div className="category-item bg-heath">
                ...
                <div className="category-text">
                  <h4>
                    <Link href="/tours">Sea Beaches</Link>
                  </h4>
                  <span>24+ tour</span>
                </div>
              </div>
            ...
            <div className="col-xl-2 col-lg-4 col-md-6 col-sm-6">
              <div className="category-item bg-heath">
                ...
                <div className="category-text">
                  <h4>
                    <Link href="/tours">Forest Tours</Link>
                  </h4>
                  <span>14+ tour</span>
                </div>
              </div>
