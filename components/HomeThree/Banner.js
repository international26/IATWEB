...
const Banner = () => {
  return (
    <>
      <div
        className="hero-wrap style3 bg-f"
        style={{
          backgroundImage: `url(/images/hero/hero-bg-3.jpg)`,
        }}
      >
          ...
          <div className="row">
            <div className="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
              <div className="hero-content text-center">
                ...
                <Link href="/tour/details" className="btn v7">
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <form className="filter-tours-wrap style3">
                ...
                <div className="filter-box">
                  ...
                  <div className="filter-dropdown">
                    <select className="hero-filter-three">
                      <option defaultValue="1">02</option>
                      <option defaultValue="2">03</option>
                      <option defaultValue="3">04</option>
                    </select>
                    <span className="hero-filter-down-arrow lh-1">
