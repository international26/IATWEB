            ...
            <div className="tour-details-info">
              ...
              <div className="tour-details-feature">
                ...
                <ul>
                  ...
                  <li>
                    <i className="ri-arrow-right-s-line"></i> Lorem ipsum dolor
                    sit At vero eos et accusamus et iusto odio dignissimos
              ...
              <div className="sidebar-widget tour-book">
                ...
                <div className="select-person">
                  <select className="tour-filter-one">
                    ...
                    <option defaultValue="2">1 Person</option>
                    <option defaultValue="3">2 Person</option>
                  </select>
